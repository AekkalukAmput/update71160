...
class Mtemp extends React.Component {
  constructor(props) {
    ...
    render() {
      ...
      var mr = new Array;
      var tr = new Array;
      const ts2=[70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70]
      const ts1=[30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30]
      ...
      // }
        ...
        if (this.state.loading) {
          var dateTime = ['DD','MM','YY'];
            ...
            var endDate = moment(dateTime).add(-1,'M');
            var startDate = moment(endDate).add(-1,'M');
            var timeValue = [];
        ...
        const configTemp = {
                    title: {
                        text: '<span style="font-family:supermarket;font-size:26px;color:black">กราฟแสดงผลอุณหภูมิแบบรายเดือน</span>'
                    },
                    ...
                    plotOptions: {
                      series: {
                          pointStart: Date.UTC(dateTime[0],dateTime[1]-2,dateTime[2],0,0,0),
        ...
        const configMois = {
                    title: {
                        text: '<span style="font-family:supermarket;font-size:26px;color:black">กราฟแสดงผลความชื้นแบบรายเดือน</span>'
                    },
      ...
      return(
        ...
        <Valve/>
        <Link to={{ pathname:'/dtemp' , query: {sen_select:this.state.select} }}><button className="bt-sensor"><span className="glyphicon glyphicon-stats"></span> รายวัน</button></Link>&nbsp;
        ...
        <button className="bt-sensor" disabled><span className="glyphicon glyphicon-stats"></span> รายเดือน</button>&nbsp;
        <br/><br/>
          <div>
